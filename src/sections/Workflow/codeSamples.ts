...
export const curl_1 = `curl 'https://api.collect.so/api/v1/...' \\
...
func main() {
\tapiURL := "https://api.collect.so/api/v1/..."
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let api_url = "https://api.collect.so/api/v1/...";
...
$api_url = "https://api.collect.so/api/v1/...";
...
public class ApiRequest {
    public static void main(String[] args) throws Exception {
        String apiUrl = "https://api.collect.so/api/v1/...";
...
let apiUrl = URL(string: "https://api.collect.so/api/v1/...")!
...
api_url = URI.parse("https://api.collect.so/api/v1/...")
token = ENV['API_TOKEN']
data = '...'
...
func main() {
\tapiURL := "https://api.collect.so/api/v1/records"
\ttoken := os.Getenv("API_TOKEN")
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let api_url = "https://api.collect.so/api/v1/records";
    let token = env::var("API_TOKEN").expect("API_TOKEN must be set");
...
$api_url = "https://api.collect.so/api/v1/records";
$token = getenv('API_TOKEN');
...
public class ApiRequest {
    public static void main(String[] args) throws Exception {
        String apiUrl = "https://api.collect.so/api/v1/records";
        String token = System.getenv("API_TOKEN");
...
let apiUrl = URL(string: "https://api.collect.so/api/v1/records")!
let token = ProcessInfo.processInfo.environment["API_TOKEN"] ?? ""
...
api_url = URI.parse("https://api.collect.so/api/v1/records")
token = ENV['API_TOKEN']
...
func main() {
\tapiURL := "https://api.collect.so/api/v1/records/search"
\ttoken := os.Getenv("API_TOKEN")
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let api_url = "https://api.collect.so/api/v1/records/search";
    let token = env::var("API_TOKEN").expect("API_TOKEN must be set");
...
api_url = URI.parse("https://api.collect.so/api/v1/records/search")
token = ENV['API_TOKEN']
...
api_url = "https://api.collect.so/api/v1/records/search"
token = os.getenv("API_TOKEN")
...
let apiUrl = URL(string: "https://api.collect.so/api/v1/records/search")!
let token = ProcessInfo.processInfo.environment["API_TOKEN"] ?? ""
...
public class ApiRequest {
    public static void main(String[] args) throws Exception {
        String apiUrl = "https://api.collect.so/api/v1/records/search";
        String token = System.getenv("API_TOKEN");
