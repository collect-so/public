...
const scenarios = [
  ...
  },
  {
    ...
    description:
      "Whether you're pushing single a Record or importing thousands of them, do it in milliseconds. Your data’s shape doesn’t constrain you because Collect adapts to it on the fly.",
  ...
  },
  {
    ...
    description:
      "Precisely fetch a specific Record or filter through complex datasets. Build complex queries effortlessly using Related Search capabilities, including $AND, $OR, $NOT, $XOR operators, and others.",
